...
//Example
<eternalsingularity:combined_singularity:16>.displayName = "ChronicV2";

//Example
<eternalsingularity:combined_singularity:17>.displayName = "ChronicV3";

//Example
<eternalsingularity:combined_singularity:18>.displayName = "ChronicV4";

recipes.removeShaped(<woot:upgrade:5>, [[<woot:factorybase>, <woot:factorycore:4>], [<minecraft:enchanted_book>, null]]);
...
recipes.removeShaped(<projecte:item.pe_philosophers_stone>, [[<minecraft:redstone>, <minecraft:glowstone_dust>, <minecraft:redstone>], [<minecraft:glowstone_dust>, <ore:gemAll>, <minecraft:glowstone_dust>], [<minecraft:redstone>, <minecraft:glowstone_dust>, <minecraft:redstone>]]);
